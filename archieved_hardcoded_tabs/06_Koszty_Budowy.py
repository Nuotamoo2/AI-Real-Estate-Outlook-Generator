...
import pandas as pd
from utils import setup_session_state, load_css, render_sidebar, display_ai_section, clean_number_formatting, render_page_header
...
if st.session_state.data_loaded:
    if st.session_state.ceny_bud and st.session_state.ceny_bud.get('data') is not None:
        ...
        st.error("Błąd AI podczas skanowania pliku o kosztach. Sprawdź, czy klucz API jest poprawny i czy plik istnieje.")
else:
